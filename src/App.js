  ...
  constructor(props) {
    ...
    this.state = {
      ...
      allOpCo: [
        ...
        { num: "002", name: "Atlanta", timezone: "" },
        { num: "003", name: "Jacksonville", timezone: "" },
        { num: "004", name: "Central California", timezone: "" },
        { num: "005", name: "Intermountain", timezone: "" },
        { num: "006", name: "Dallas", timezone: "" },
        { num: "007", name: "Virginia", timezone: "" },
        { num: "008", name: "Northern New England", timezone: "" },
        { num: "009", name: "Pittsburgh", timezone: "" },
        { num: "010", name: "Eastern Maryland", timezone: "" },
        { num: "011", name: "Louisville", timezone: "" },
        { num: "012", name: "Baltimore", timezone: "" },
        { num: "013", name: "Central Texas", timezone: "" },
        { num: "014", name: "Memphis", timezone: "" },
        { num: "015", name: "Cleveland", timezone: "" },
        { num: "016", name: "South Florida", timezone: "" },
        { num: "017", name: "Las Vegas", timezone: "" },
        { num: "018", name: "Baraboo", timezone: "" },
        { num: "019", name: "Cincinnati", timezone: "" },
        { num: "022", name: "Central Florida", timezone: "" },
        { num: "023", name: "New Orleans", timezone: "" },
        { num: "024", name: "Chicago", timezone: "" },
        { num: "025", name: "Albany", timezone: "" },
        { num: "026", name: "Oklahoma", timezone: "" },
        { num: "027", name: "Syracuse", timezone: "" },
        { num: "029", name: "Arkansas", timezone: "" },
        { num: "031", name: "Sacramento", timezone: "" },
        { num: "032", name: "Southeast Florida", timezone: "" },
        { num: "035", name: "Eastern Wisconsin", timezone: "" },
        { num: "036", name: "San Diego", timezone: "" },
        { num: "037", name: "West Coast Florida", timezone: "" },
        { num: "038", name: "Indianapolis", timezone: "" },
        { num: "039", name: "Iowa", timezone: "" },
        { num: "040", name: "Idaho", timezone: "" },
        { num: "043", name: "Montana", timezone: "" },
        { num: "045", name: "Los Angeles", timezone: "" },
        { num: "046", name: "Central Alabama", timezone: "" },
        { num: "047", name: "Minnesota", timezone: "" },
        { num: "048", name: "Charlotte", timezone: "" },
        { num: "049", name: "Arizona", timezone: "" },
        { num: "050", name: "San Francisco", timezone: "" },
        { num: "051", name: "Central Pennsylvania", timezone: "" },
        { num: "052", name: "Portland", timezone: "" },
        { num: "054", name: "Connecticut", timezone: "" },
        { num: "055", name: "Seattle", timezone: "" },
        { num: "056", name: "Boston", timezone: "" },
        { num: "057", name: "Kansas City", timezone: "" },
        { num: "058", name: "Detroit", timezone: "" },
        { num: "059", name: "Denver", timezone: "" },
        { num: "060", name: "Nashville", timezone: "" },
        { num: "061", name: "Lincoln", timezone: "" },
        { num: "063", name: "Sygma Pennsylvania", timezone: "" },
        { num: "064", name: "St. Louis", timezone: "" },
        { num: "066", name: "New Mexico", timezone: "" },
        { num: "067", name: "Houston", timezone: "" },
        { num: "068", name: "Grand Rapids", timezone: "" },
        { num: "073", name: "Hampton Roads", timezone: "" },
        { num: "075", name: "Philadelphia", timezone: "" },
        { num: "076", name: "Metro New York", timezone: "" },
        { num: "078", name: "West Texas", timezone: "" },
        { num: "080", name: "Sygma Florida", timezone: "" },
        { num: "089", name: "Sygma San Antonio", timezone: "" },
        { num: "101", name: "Ventura", timezone: "" },
        { num: "102", name: "Spokane ", timezone: "" },
        { num: "103", name: "Asian Foods", timezone: "" },
        { num: "137", name: "Columbia", timezone: "" },
        { num: "163", name: "Raleigh", timezone: "" },
        { num: "164", name: "Gulf Coast", timezone: "" },
        { num: "194", name: "Central Illinois", timezone: "" },
        { num: "195", name: "North Dakota", timezone: "" },
        { num: "223", name: "Southern California", timezone: "" },
        { num: "288", name: "Knoxville ", timezone: "" },
        { num: "293", name: "East Texas", timezone: "" },
        { num: "306", name: "Long Island", timezone: "" },
        { num: "320", name: "Riverside", timezone: "" },
        { num: "332", name: "Western Minnesota", timezone: "" },
        { num: "338", name: "South Western Ontario", timezone: "" },
        { num: "348", name: "Sygma Fort Worth", timezone: "" },
